...
<?php require ("../../layout/header.php"); ?>
                    ...
                    <a  href="/thuctap2020/admin/module/category/add.php">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `danhmuc` LIMIT $perRow,$rowPerpage";
                        $query = mysqli_query($connect, $sql);
                        $totalRows =  mysqli_num_rows(mysqli_query($connect, "SELECT * FROM danhmuc"));
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info" href="edit.php?id=<?php echo $rows['maDM']?>"> <i class="fa fa-edit" ></i>&nbsp;</a>
                                                <a class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa danh mục này này?')" href="delete.php?id=<?php echo $rows['maDM']?>"><i class="fas fa-trash"></i>&nbsp;</a>
                                            </td>
                                        </tr>
                                        <?php
                                            }
